...
par(op)
cn = 1
par(mfrow=c(2,2),cex=0.35,mar=c(6,4,4,5))
...
#         ylim=c(0,0.03),
  ...
  mtext("New Fatalities as Fraction of Total Expected", cex=0.35,side=4, line=3, cex.lab=0.3, col="black",las=3)
